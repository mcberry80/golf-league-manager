...
func TestAssignStrokes(t *testing.T) {
	...
	tests := []struct {
		name             string
		playerAHandicap  HandicapRecord
		playerBHandicap  HandicapRecord
...
func TestAssignStrokes_StrokeAllocation(t *testing.T) {
	...
	playerA := HandicapRecord{
		PlayerID:        "playerA",
		PlayingHandicap: 12,
	}
	playerB := HandicapRecord{
		PlayerID:        "playerB",
		PlayingHandicap: 9,
	}
...
func TestHandleAbsence(t *testing.T) {
	...
	tests := []struct {
		name            string
		absentPlayer    HandicapRecord
		lastFiveRounds  []Round
